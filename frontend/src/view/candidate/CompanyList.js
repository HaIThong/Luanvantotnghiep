...
function CompanyList() {
  ...
  return (
    <div className="bg-cl" >
    <div style={{ margin: "0px 100px", paddingBottom: "60px", }}>
      {/* Search Bar */}
      <form className="d-flex pt-5 ps-2" onSubmit={handleSubmit}>
        <input
          type="text"
      ...
      <h4 className="my-3  text-center text-job" style={{ fontSize: '3rem' }}>
      LIST OF COMPANIES
</h4>
      ...
      <div className="row mt-3">
        {companies.length > 0 ? (
          companies.map((company) => (
            <div
              className="col-sm-12 col-lg-4 mb-3 pointer1"
