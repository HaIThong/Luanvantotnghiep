  ...
  const PersonalPart = ({ bgColor }) => {
    return (
      <InforPart type="personal ">
        ...
        />
        <div className="d-flex ms-5 w-90 ">
          <div className="w-100 ">
            <FlexInput
              innerClassName={clsx('content bg-tr1 ', bgColor)}
              iconLeft={<IoCalendarClear className="mb-1 icon1 " />}
              className="align-items-center mt-0"
            ...
            />
            <FlexInput
              className="align-items-center mt-2 header1 "
              innerClassName={clsx('content bg-tr1', bgColor)}
              iconLeft={<FaPhoneAlt className="mb-1 icon1" />}
            ...
            <FlexInput
              ...
              innerClassName={clsx('content bg-tr1', bgColor)}
              iconLeft={<IoMdMail className="mb-1 icon1" />}
              placeholder="Email"
          ...
          <div className="w-100">
            <FlexInput
              className="align-items-center mt-2"
              innerClassName={clsx('content bg-tr1', bgColor)}
              iconLeft={<IoIosLink className="mb-1 icon1" />}
              placeholder="Liên kết"
            ...
            <FlexInput
              className="align-items-center mt-2"
              innerClassName={clsx('content bg-tr1', bgColor)}
              iconLeft={<MdLocationOn className="fs-5 mb-1 icon1" />}
              placeholder="Địa chỉ"
    ...
    <>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div
          id="resume"
          ref={contentRef}
          className="mx-auto border mt-2 mb-5  shadow-sm  border-dark ps-0 pe-0 "
          style={{ width: '800px' }}
        >
          <div className="cv-bg-main ps-0 pe-0 w-100 ">
            <div className=" d-flex align-items-start gap-2 p-2 bg-head1 ">
              <img
                ...
                style={{marginTop:"52px",marginLeft:"50px" }}
              />
              <div className="w-100 p-3 mt-2 ">
                <FlexInput
                  placeholder="HỌ TÊN"
                  className="mt-2 mb-1"
                  innerClassName="h1 cv-bg-main cv-text-main2 text-uppercase"
